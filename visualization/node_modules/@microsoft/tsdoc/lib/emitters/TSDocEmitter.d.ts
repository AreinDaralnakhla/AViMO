import type { DocComment, DocDeclarationReference, DocHtmlEndTag, DocHtmlStartTag } from '@microsoft/tsdoc/src/nodes';
import type { IStringBuilder } from '@microsoft/tsdoc/src/emitters/StringBuilder';
/**
